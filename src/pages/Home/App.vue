<template>
  <div id="app" class="bg-secondary">
      ...
      <div class="container-xxl position-absolute header-content">
        <div class="col">
          <p
            ...
            "
          >
            as melhores séries e filmes
          </p>
          <p
            class="text-white text-uppercase h1 text-center letter-spacing"
          ...
          <div class="row justify-content-center">
            <img
              ...
              class="img-fluid w-50 pb-3"
              v-once
            />
          </div>

          <p class="text-white text-center">
            Após esse período, assinaturas a partir de R$14,16/mês* no plano
            anual.
          </p>
          ...
          <div class="row justify-content-center">
            <b-button
              ...
              >experimente grátis</b-button
            >
          </div>
          <div class="row justify-content-center">
            <p class="text-center py-2 w-25 header__bottom-text">
              O período de teste gratuito é apenas para novos assinantes.
      ...
      <div class="row pt-5" style="border: 1px solid red">
        <div class="col-12">
          <p class="fs-5 text-white text-center">
            Alerta de spoiler: a HBO Max tem novidades para você
          </p>
        </div>
        <div class="col-12">
          <div class="row justify-content-center">
            <div class="slider w-100" style="height: 200px">
              <div class="slider-track" style="height: 100px">
                <home-slider-item
                  :img_url="'https://hbomax-images.warnermediacdn.com/2021-09/pretty-little-liars.jpg?host=wme-hbomax-drupal-prod.s3.amazonaws.com'"
                  :text="'em breve'"
                  :width="200"
                ></home-slider-item>
    ...
    <section class="container-xl py-5">
      <div class="row justify-content-center">
        <p class="text-white text-center h4 fw-normal">
        ...
        <img
          src="https://hbomax-images.warnermediacdn.com/2021-08/br_devices_trophy.png?host=wme-hbomax-drupal-prod.s3.amazonaws.com&w=1007"
    ...
    <section class="container">
      <div class="row py-5">
        <section-2-item
          :text="'Crie até 5 perfis e receba recomendações personalizadas para cada um'"
        />
        <section-2-item
          :text="'Baixe qualquer conteúdo disponível para assistir offline'"
        />
        <section-2-item
          :text="'Defina o conteúdo que as crianças podem assistir de acordo com cada faixa etária'"
        />
        <section-2-item
          :text="'Adicione seus títulos favoritos para assistir quando quiser'"
        />
      </div>
    </section>
    <section class="container">
      <div class="row align-items-center justify-content-center py-3">
        ...
        <div class="col-12 col-md-4">
          <img
            src="https://hbomax-images.warnermediacdn.com/2021-05/fam_and_kids-looney_toons-img.png?host=wme-hbomax-drupal-prod.s3.amazonaws.com&w=480"
            class="img-fluid"
            v-once
          />
        </div>
    ...
    <section class="container-fluid py-3 section-experimente-gratis-background">
      <div class="container py-4">
        <div class="col">
          <div class="row justify-content-center">
            <img
              src="https://hbomax-images.warnermediacdn.com/2021-07/bpo_1.png?host=wme-hbomax-drupal-prod.s3.amazonaws.com&w=1215"
    ...
    <section class="container py-5 d-none d-lg-block">
      <div class="row py-4 align-items-center">
        <div class="col container-shadow-effect">
          <div class="row">
            <div class="col shadow-effect">
              <img
                src="https://hbomax-images.warnermediacdn.com/2021-03/euphoria-_1_0.png?host=wme-hbomax-drupal-prod.s3.amazonaws.com&w=170"
                class="w-100 mx-1 img-shadow-effect"
              />
            </div>
            <div class="col shadow-effect">
              <img
        ...
        <div class="col">
          <div class="row justify-content-center">
            <h4 class="text-white text-center fw-semi-bold pt-3">
              Curta episódios completos gratuitos sem a necessidade de
              assinatura.
            </h4>
            <b-button
              pill
    ...
    <section class="container py-5">
      ...
      <div class="row py-5">
        ...
        <devices-section-item
          :icon="'laptop'"
          :title="'Computadores'"
          :options="['Chrome OS', 'MacOS', 'Windows PC']"
        />
        <devices-section-item
          :icon="'gamepad'"
          :title="'Video-games'"
          :options="['Xbox One', 'Xbox Series XIS']"
        />
        <devices-section-item
          :icon="'tablet-alt'"
          :title="'Smartphones e Tablets'"
          :options="['Android Phone & Tablet', 'iPhone & iPad']"
        />
      </div>
    </section>
    <section class="container">
